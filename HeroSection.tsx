  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img 
          src={heroImage} 
          alt="Estate Nest Capital headquarters" 
          ...
          <div className="space-y-16">
            ...
            <div className="space-y-8 float-animation text-left">
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-3xl leading-relaxed">
                Edmonton-rooted real estate investment firm creating lasting value through strategic acquisitions and development.
              </p>
            </div>

            {/* Secondary Messages */}
            <div className="grid md:grid-cols-2 gap-12 mt-20">
              <div className="space-y-4 group hover:scale-105 transition-transform duration-500 p-8 rounded-2xl hover:bg-white/10 backdrop-blur-sm">
